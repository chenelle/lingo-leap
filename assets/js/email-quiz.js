...
function showEmailGate() {
    ...
    // We already have their email via the newsletter form, so we can just mock it 
    // or leave it blank since they came from an email campaign.
    localStorage.setItem('userEmail', 'Subscriber');

    // Redirect straight to results page
